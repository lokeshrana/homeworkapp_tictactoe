...
export default new ClientModule({
  route: [
    <AuthRoute
      ...
      redirect="/login"
      component={loadable(() =>
        import("./containers/Profile").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      role="admin"
      component={loadable(() =>
        import("./containers/Users").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      role={["admin"]}
      component={loadable(() =>
        import("./containers/UserAdd").then((c) => c.default)
      )}
    />,
    <AuthRoute
      path="/users/:id"
      ...
      role={["user", "admin"]}
      component={loadable(() =>
        import("./containers/UserEdit").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      redirect="/profile"
      component={loadable(() =>
        import("./containers/Register").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      redirect="/"
      component={loadable(() =>
        import("./containers/Login").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      redirect="/profile"
      component={loadable(() =>
        import("./containers/ForgotPassword").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      redirect="/profile"
      component={loadable(() =>
        import("./containers/ResetPassword").then((c) => c.default)
      )}
    />,
  ],
  navItem: [
